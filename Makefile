...
help:
	...
	@echo "  upload-thumbnails        - Upload character thumbnails to Supabase Storage"
	@echo "                             Use --force to re-upload all, --limit N to test"
	@echo "                             e.g. uv run python scripts/upload_character_thumbnails.py --limit 10 --force"
